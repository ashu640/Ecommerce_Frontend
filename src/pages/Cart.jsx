...
const Cart = () => {
  ...
  return (
    <div className='conatiner mx-auto px-4 py-8'><h1 className='text-3xl font-bold mb-6 text-center'>Your Cart</h1>
    {
...
<img src={e.product.images[0].url} alt={e.product.title} className='w-full sm:w-20 sm:h-20 object-cover rounded:md cursor-pointer' 
...
<Button variant="ghost" className="text-red-600" onClick={()=>removeFromCart(e._id)}><Trash className="w-5 h-5"></Trash></Button>
        ...
        <div className="p-6 shadow-lg rounded-lg border border-gray-400"><h2 className='text-xl font-semibold mb-4 text-center lg:text-left'>order Summary</h2>
        <Separator className="m-y-2"></Separator>
        ...
        <Button className="w-full mt-6" onClick={()=>navigate("/checkout")} disabled={cart.length===0}>
          Checkout
        </Button>
